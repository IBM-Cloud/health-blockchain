  ...
  render() {
    ...
    return (
      <SiteLayout
        ...
        toggle={  <div className="visualToggle"><img className="bannerLink" src="/images/phone.svg" title="Phone App only"></img><Toggle
            id="myToggle"
            labelA=""
            labelB=""
            className="toggler"
          ...
          /><img className="bannerLink" src="/images/blockchain.svg" title="Phone & Blockchain Explorer"></img></div>}
      >
